 ...
 */
package org.opendaylight.alto.pathvector.cli.commands;
...
public class PathVectorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PathVectorCliTestCommand.class);
    protected final PathVectorCliCommands service;

    public PathVectorCliTestCommand(final PathVectorCliCommands service) {
